...
function Delete({onDeleteBtnClick,type,title,setIsDeleteModalOpen}) {
  return (
    <div
    onClick={(e)=>{
    ...
    className='fixed right-0 top-0 px-2 py-4 overflow-scroll scrollbar-hide z-10 left-0 bottom-0 justify-center items-center flex dropdown'
    >
